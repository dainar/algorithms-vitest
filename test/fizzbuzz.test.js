...
describe("fizzbuzz", () => {
    // This test is already covered with the other cases
    // it("should be a function", () => {
    //     expect(typeof fizzbuzz).toBe("function")
    // })

    it("should throw if not nomber is provided as parameter", () => {
        expect(()=>fizzbuzz()).toThrow()
    })

    it("should throw a specific error message if not nomber is provided as parameter", () => {
